# [E1] - Ticket Booking System - QUEUE by Edrian Guanzon
...
1. enqueue() -> Adds customer to ticket booking queue
2. dequeue() -> removes customer from ticket booking queue after serving the customer
3. serveCustomer() -> removes the first customer from the ticket booking queue and allocates tickets according to their request. It also updates the total available tickets. Print messages for the following scenarios:
